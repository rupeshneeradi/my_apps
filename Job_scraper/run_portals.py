#!/usr/bin/env python3
"""
Portal Pipeline Runner — v1.0.6
Schedule: Monday–Friday at 6:45 AM
Portals: LinkedIn, Indeed, Dice, Monster
"""
import logging
import os
import sys
...
from portal_scraper import scrape_portals
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("logs/portal_pipeline.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("run_portals")
...
def main():
    ...
    try:
        ...
        log.info("Scraping portals: LinkedIn, Indeed, Dice, Monster...")
        raw_jobs = scrape_portals()
