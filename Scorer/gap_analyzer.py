...
ROLE_PROFILES: dict[str, dict] = {
    ...
    "mobile developer": {
        "aliases": ["mobile app developer", "cross-platform developer"],
    ...
    "ai engineer": {
        "aliases": ["llm engineer", "generative ai engineer", "ml engineer",
                    "machine learning engineer", "ai developer",
                    "applied ai engineer", "foundation model engineer"],
        "core":      ["python", "pytorch", "llm", "langchain", "rest api",
                      "prompt engineering", "rag", "vector database", "git",
                      "api design"],
        "important": ["hugging face", "openai api", "langGraph", "fine-tuning",
                      "embeddings", "docker", "fastapi", "aws/gcp/azure",
                      "model evaluation", "streaming inference"],
        "nice":      ["kubernetes", "mlflow", "vllm", "quantization",
                      "multimodal", "agents", "function calling", "anthropic api"],
        "certs": ["DeepLearning.AI – LLM specialization (free audit)",
                  "AWS Certified Machine Learning – Specialty",
                  "Google Professional Machine Learning Engineer"],
        "resources": ["fast.ai – Practical Deep Learning (free)",
                      "LangChain Academy – free crash course",
                      "Andrej Karpathy – Zero to Hero (free YouTube)"],
    },

    "mlops engineer": {
        "aliases": ["ml platform engineer", "machine learning ops",
                    "ai infrastructure engineer", "ml devops"],
        "core":      ["python", "mlflow", "docker", "kubernetes", "ci/cd",
                      "git", "cloud (aws/gcp/azure)", "model serving", "airflow"],
        "important": ["kubeflow", "sagemaker", "vertex ai", "azure ml",
                      "feature store", "model monitoring", "data pipeline",
                      "databricks", "spark", "terraform"],
        "nice":      ["bentoml", "seldon", "ray serve", "dvc",
                      "grafana", "prometheus", "helm"],
        "certs": ["AWS Certified Machine Learning – Specialty",
                  "Google Professional MLOps Engineer",
                  "Databricks Certified Associate Developer"],
        "resources": ["Made With ML – free MLOps guide",
                      "Full Stack Deep Learning (free)",
                      "MLflow documentation (free)"],
    },

    "business analyst": {
        "aliases": ["it business analyst", "systems analyst", "functional analyst",
                    "requirements analyst", "ba", "process analyst"],
        "core":      ["requirements gathering", "user stories", "brd",
                      "stakeholder management", "process mapping", "bpmn",
                      "use cases", "uat", "jira", "sql"],
        "important": ["visio/lucidchart", "excel/data analysis", "agile/scrum",
                      "confluence", "gap analysis", "as-is/to-be", "change management",
                      "power bi/tableau", "wireframing/mockups", "api understanding"],
        "nice":      ["python basics", "tableau/power bi", "ml basics",
                      "looker", "six sigma", "business case writing"],
        "certs": ["CBAP – Certified Business Analysis Professional",
                  "PMI-PBA – Professional in Business Analysis",
                  "Certified Scrum Product Owner (CSPO)"],
        "resources": ["BABOK Guide – free sample chapters",
                      "BA Times – free articles & templates",
                      "Coursera – Business Analysis & Process Management (free audit)"],
    },

    "salesforce developer": {
        "aliases": ["salesforce admin", "salesforce administrator",
                    "sfdc developer", "salesforce consultant",
                    "salesforce solution architect"],
        "core":      ["apex salesforce", "lwc", "soql", "salesforce flow",
                      "salesforce admin", "git", "rest api", "profiles/permission sets",
                      "salesforce crm", "visual studio code"],
        "important": ["salesforce sales cloud", "service cloud", "experience cloud",
                      "validation rules", "process builder", "sfdx/sf cli",
                      "salesforce integration", "data loader", "ci/cd salesforce",
                      "mulesoft basics"],
        "nice":      ["salesforce cpq", "salesforce marketing cloud",
                      "salesforce pardot", "einstein analytics",
                      "salesforce shield", "tableau crm"],
        "certs": ["Salesforce Certified Administrator",
                  "Salesforce Certified Platform Developer I",
                  "Salesforce Certified Platform App Builder"],
        "resources": ["Trailhead – Salesforce free learning platform",
                      "Salesforce Developer docs (free)",
                      "Focus on Force – free study guides"],
    },

    "sap consultant": {
        "aliases": ["sap developer", "sap abap developer", "sap technical consultant",
                    "sap functional consultant", "sap analyst", "sap hana developer"],
        "core":      ["sap abap", "sap s/4hana", "sap fiori", "sapui5",
                      "odata", "bapi/badi", "user exits", "sap workflow",
                      "sap transport", "git"],
        "important": ["sap btp", "sap integration suite", "rest api sap",
                      "sap hana", "sap mm/sd/fi/co", "enhancement framework",
                      "sap debug", "abap oo", "idocs", "sap security"],
        "nice":      ["sap bw/4hana", "sap successfactors", "sap ariba",
                      "cap model", "sap low code", "openui5"],
        "certs": ["SAP Certified Development Associate – ABAP",
                  "SAP Certified Technology Associate – SAP BTP",
                  "SAP Certified Application Associate – S/4HANA"],
        "resources": ["SAP Learning Hub – many free courses",
                      "SAP Community (free tutorials)",
                      "openSAP – free MOOCs"],
    },

    "workday consultant": {
        "aliases": ["workday developer", "workday hcm consultant",
                    "workday integration developer", "workday analyst",
                    "workday functional consultant"],
        "core":      ["workday hcm", "workday business process", "eib",
                      "calculated fields", "workday report writer",
                      "workday security", "workday tenant", "xml/xslt"],
        "important": ["workday studio", "workday integration", "workday payroll",
                      "workday recruiting", "workday benefits",
                      "workday prism", "workday extend", "raas"],
        "nice":      ["workday financials", "workday adaptive planning",
                      "rest api workday", "workday certification"],
        "certs": ["Workday HCM Core Certification (vendor-provided)",
                  "Workday Integration Certification"],
        "resources": ["Workday Community – official docs (requires account)",
                      "Udemy – Workday HCM courses",
                      "LinkedIn Learning – Workday tutorials"],
    },

    "servicenow developer": {
        "aliases": ["servicenow admin", "servicenow administrator",
                    "servicenow consultant", "servicenow engineer",
                    "itsm developer", "snow developer"],
        "core":      ["servicenow scripting", "glide record", "business rules",
                      "client scripts", "ui policies", "flow designer",
                      "service catalog", "rest api servicenow", "git", "javascript"],
        "important": ["cmdb", "change management itil", "incident management",
                      "problem management", "servicenow integration", "atf",
                      "servicenow discovery", "itsm", "acls servicenow",
                      "update sets"],
        "nice":      ["servicenow hrsd", "servicenow itom", "event management",
                      "service mapping", "servicenow performance analytics"],
        "certs": ["ServiceNow Certified System Administrator (CSA)",
                  "ServiceNow Certified Application Developer (CAD)",
                  "ITIL 4 Foundation"],
        "resources": ["NowLearning – ServiceNow free courses",
                      "ServiceNow developer instance (free sandbox)",
                      "ServiceNow community docs (free)"],
    },

    "network engineer": {
        "aliases": ["network administrator", "cloud network engineer",
                    "network security engineer", "systems administrator",
                    "it infrastructure engineer", "sysadmin"],
        "core":      ["tcp/ip", "routing & switching", "bgp/ospf",
                      "vlan/stp", "firewall/acl", "dns/dhcp",
                      "cisco ios", "network troubleshooting", "linux", "wireshark"],
        "important": ["sdwan", "vpn", "network monitoring", "aws networking",
                      "azure networking", "active directory", "vmware",
                      "load balancer", "wireless/wi-fi", "network automation"],
        "nice":      ["python scripting", "ansible", "terraform",
                      "kubernetes networking", "cloud networking", "palo alto"],
        "certs": ["CompTIA Network+",
                  "Cisco CCNA",
                  "AWS Advanced Networking – Specialty"],
        "resources": ["Cisco Learning Network – free study materials",
                      "Professor Messer – CompTIA Network+ (free YouTube)",
                      "David Bombal – Networking (free YouTube)"],
    },

    "scrum master": {
        "aliases": ["agile coach", "agile scrum master", "sr scrum master",
                    "agile delivery manager", "release train engineer"],
        "core":      ["agile/scrum", "sprint planning", "retrospectives",
                      "daily standups", "backlog refinement", "jira",
                      "impediment removal", "stakeholder communication",
                      "release planning", "team coaching"],
        "important": ["kanban", "safe/scaled agile", "confluence",
                      "metrics (velocity/burndown)", "product backlog",
                      "azure devops boards", "conflict resolution",
                      "capacity planning", "risk management", "ado"],
        "nice":      ["program increment planning", "devops basics",
                      "okrs", "ux basics", "change management"],
        "certs": ["Certified ScrumMaster (CSM)",
                  "Professional Scrum Master (PSM I)",
                  "SAFe Scrum Master (SSM)"],
        "resources": ["Scrum.org – free learning resources",
                      "Agile Alliance – free articles",
                      "Mountain Goat Software – free guides (Mike Cohn)"],
    },

    "help desk technician": {
        "aliases": ["it support specialist", "technical support analyst",
                    "desktop support engineer", "service desk analyst",
                    "tier 1 support", "tier 2 support", "it helpdesk"],
        "core":      ["windows os", "active directory", "troubleshooting",
                      "ticketing systems", "microsoft 365", "hardware support",
                      "networking basics", "vpn support", "printer/peripheral",
                      "communication skills"],
        "important": ["servicenow/jira", "remote desktop", "powershell basics",
                      "intune/mdm", "antivirus/endpoint", "azure ad",
                      "onboarding/offboarding", "ldap/ad management",
                      "linux basics", "office 365 admin"],
        "nice":      ["scripting (ps/python)", "sccm", "virtualization basics",
                      "cloud basics", "security awareness"],
        "certs": ["CompTIA A+",
                  "ITIL 4 Foundation",
                  "Microsoft 365 Fundamentals (MS-900)"],
        "resources": ["Professor Messer – CompTIA A+ (free YouTube)",
                      "Microsoft Learn – MS-900 (free)",
                      "Google IT Support Certificate (Coursera free audit)"],
    },

    "ios developer": {
        "aliases": ["ios engineer", "swift developer", "swiftui developer",
                    "apple developer", "iphone developer"],
        "core":      ["swift", "swiftui", "uikit", "xcode", "git",
                      "rest api", "core data", "autolayout",
                      "app store deployment", "testflight"],
        "important": ["combine/async-await", "mvvm", "push notifications",
                      "firebase", "fastlane", "unit testing (xctest)",
                      "accessibility ios", "core location", "in-app purchase",
                      "cocoapods/spm"],
        "nice":      ["arkit", "coreml", "watchos", "tvos",
                      "app clips", "widgets", "iap/subscriptions"],
        "certs": ["Apple Developer Program membership",
                  "Hacking with Swift – 100 Days (free)",
                  "AWS Certified Developer (mobile backend)"],
        "resources": ["Hacking with Swift – free",
                      "Apple Developer docs (free)",
                      "Ray Wenderlich / Kodeco – free tutorials"],
    },

    "android developer": {
        "aliases": ["android engineer", "kotlin developer",
                    "android application developer"],
        "core":      ["kotlin", "jetpack compose", "android studio", "git",
                      "rest api", "room database", "viewmodel/livedata",
                      "google play deployment", "xml layouts", "testing"],
        "important": ["coroutines/flow", "hilt/dagger", "retrofit",
                      "firebase", "material design", "push notifications (fcm)",
                      "navigation component", "gradle", "ci/cd"],
        "nice":      ["kotlin multiplatform", "compose multiplatform",
                      "ml kit", "wear os", "billing api"],
        "certs": ["Google Associate Android Developer",
                  "Kotlin Developer Certification (JetBrains)"],
        "resources": ["Android Developer guides (free on developer.android.com)",
                      "Philipp Lackner – Android YouTube (free)",
                      "Google Codelabs – Android (free)"],
    },

    "react native developer": {
        "aliases": ["rn developer", "react native engineer",
                    "cross platform developer", "expo developer"],
        "core":      ["react native", "javascript", "typescript", "expo",
                      "rest api", "git", "react navigation",
                      "state management (redux/zustand)", "testing", "flexbox"],
        "important": ["async storage", "push notifications", "firebase",
                      "native modules", "platform-specific code", "fastlane",
                      "ci/cd", "performance optimization", "accessibility"],
        "nice":      ["reanimated", "react native gesture handler",
                      "react query", "shopify flash list", "storybook"],
        "certs": ["Meta React Native Developer Certificate",
                  "React Native course (Udemy – not free, but widely used)"],
        "resources": ["React Native docs (free)",
                      "Expo documentation (free)",
                      "William Candillon – React Native YouTube (free)"],
    },

    "site reliability engineer": {
        "aliases": ["sre", "reliability engineer", "sre engineer",
                    "production engineer", "platform reliability engineer"],
        "core":      ["kubernetes", "docker", "terraform", "python/go",
                      "prometheus/grafana", "linux", "git", "ci/cd",
                      "incident response", "on-call management"],
        "important": ["slo/sli/sla", "error budgets", "observability",
                      "distributed tracing", "capacity planning",
                      "chaos engineering", "runbooks/playbooks",
                      "aws/gcp/azure", "ansible", "alertmanager"],
        "nice":      ["service mesh", "ebpf", "opentelemetry",
                      "postmortem facilitation", "toil reduction",
                      "cost optimization"],
        "certs": ["Google SRE Certificate (free ebook – Google)",
                  "Certified Kubernetes Administrator (CKA)",
                  "AWS DevOps Engineer Professional"],
        "resources": ["Google SRE Book (free at sre.google)",
                      "CKA prep – killer.sh (paid labs)",
                      "cloudnative.tv – free YouTube"],
    },

    "cloud security engineer": {
        "aliases": ["cloud security analyst", "cloud security architect",
                    "security engineer cloud", "aws security engineer"],
        "core":      ["cloud iam", "aws/azure/gcp security", "terraform",
                      "container security", "vulnerability scanning",
                      "incident response", "zero trust", "siem",
                      "secrets management", "network security"],
        "important": ["devsecops", "sast/dast", "policy as code (opa)",
                      "cspm", "cwpp", "trivy/aqua/snyk",
                      "compliance (soc2/pci/hipaa)", "penetration testing",
                      "cloud forensics", "threat modeling"],
        "nice":      ["cnapp", "ebpf security", "waf",
                      "cloud pentesting", "bug bounty"],
        "certs": ["AWS Certified Security – Specialty",
                  "Certified Cloud Security Professional (CCSP)",
                  "CompTIA Security+"],
        "resources": ["AWS Security Learning Plan (free)",
                      "SANS Cloud Security reading room (free)",
                      "Cloud Security Alliance – free whitepapers"],
    },
}
...
def _find_profile(title: str) -> tuple[str, dict] | tuple[None, None]:
    ...
    kw_map = {
        # New v2 profiles first (more specific)
        "ai engineer":              ["llm", "langchain", "generative ai", "gen ai", "rag", "openai"],
        "mlops engineer":           ["mlops", "ml ops", "model deployment", "model serving", "kubeflow", "mlflow"],
        "site reliability engineer":["sre", "site reliability", "slo", "sli", "error budget", "on-call"],
        "cloud security engineer":  ["cloud security", "cspm", "cwpp", "devsecops security"],
        "business analyst":         ["business analyst", "ba role", "requirements", "stakeholder", "brd"],
        "salesforce developer":     ["salesforce", "sfdc", "lwc", "apex salesforce", "soql", "trailhead"],
        "sap consultant":           ["sap", "abap", "s/4hana", "sap fiori", "sapui5", "sap btp"],
        "workday consultant":       ["workday", "workday hcm", "workday payroll", "workday integration"],
        "servicenow developer":     ["servicenow", "service now", "snow developer", "glide record"],
        "network engineer":         ["network engineer", "cisco", "routing", "switching", "bgp", "vlan"],
        "scrum master":             ["scrum master", "agile coach", "sprint", "safe", "release train"],
        "help desk technician":     ["help desk", "helpdesk", "desktop support", "it support", "service desk"],
        "ios developer":            ["ios", "swift", "swiftui", "uikit", "xcode", "testflight"],
        "android developer":        ["android", "kotlin android", "jetpack compose", "android studio"],
        "react native developer":   ["react native", "rn developer", "expo"],
        # Original profiles
    ...
    if not profile:
        return {
            ...
            "message": (
                ...
                "Try: Software Engineer, Data Engineer, DevOps Engineer, Site Reliability Engineer, "
                "Cloud Engineer, Cloud Security Engineer, Frontend Developer, Backend Developer, "
                "Full Stack Developer, Mobile Developer, iOS Developer, Android Developer, "
                "React Native Developer, Data Scientist, AI Engineer, MLOps Engineer, "
                "Business Analyst, Salesforce Developer, SAP Consultant, Workday Consultant, "
                "ServiceNow Developer, Network Engineer, Scrum Master, Help Desk Technician, "
                "Java Developer, Python Developer, Oracle Developer, QA Engineer, "
